...
/*   Updated: 2016/03/06 11:16:17 by hmartzol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RADIAN(x) (PI * (((float)x) / (float)180))
# define DEGRE(x) ((float)180 * (((float)x) / PI))
...
t_point3d			ft_point3d(float x, float y, float z);
